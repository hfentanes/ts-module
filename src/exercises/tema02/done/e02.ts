...
function languagesSpoken(
  ...
  let text = `The language spoken in ${country} is: ${language1}`;

  if (typeof language2 === "string") {
    text = `The languages spoken in ${country} are: ${language1} and ${language2}`;
  }
...
export { doubleThePopulation, languagesSpoken };
